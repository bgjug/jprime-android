...
public interface DBStatements {
	...
	static final String CREATE_SESSION_TABLE = String.format("CREATE TABLE %s (%s TEXT, %s TEXT, %s TEXT, %s TEXT, %s TEXT,"
			+ " %s TEXT, %s TEXT, %s INTEGER);", TABLE_SESSION, FIELD_NAME, FIELD_DESCRIPTION, FIELD_SPEAKER, FIELD_COSPEAKER, FIELD_HALL, FIELD_STARTTIME, FIELD_ENDTIME, FIELD_ISFAVORITE);
