...
public interface DBStatements {
	...
	static final String FIELD_IS_WORKSHOP = "ISWORKSHOP";
	static final String CREATE_SESSION_TABLE = String.format("CREATE TABLE %s (%s TEXT, %s TEXT, %s TEXT, %s TEXT, %s TEXT,"
			+ " %s TEXT, %s TEXT, %s INTEGER, %s TEXT, %s TEXT);", TABLE_SESSION, FIELD_NAME, FIELD_DESCRIPTION, FIELD_SPEAKER_FIRST_NAME, FIELD_COSPEAKER, FIELD_HALL, FIELD_STARTTIME, FIELD_ENDTIME, FIELD_ISFAVORITE, FIELD_SPEAKER_LAST_NAME, FIELD_IS_WORKSHOP);
